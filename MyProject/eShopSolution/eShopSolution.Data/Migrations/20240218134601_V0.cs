    ...
    public partial class V0 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 2, 18, 20, 46, 1, 596, DateTimeKind.Local).AddTicks(4324), 100000m, 200000m });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName" },
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "52b5e07c-1487-4346-85af-ad1f23113cad", "Administrator role", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Dob", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, "b7a931e6-d170-4da5-a2bd-4aea6aa511a9", new DateTime(1997, 11, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "hungdt0811@gmail.com", true, "Hung", "Dang", false, null, "hungdt0811@gmail.com", "admin", "AQAAAAEAACcQAAAAEEW4e95pG7a6CLNW0TZFlNvPSu6wcNfV5o3obfw0C7NDZfZ1HCki+S68WrnAwRgb+Q==", null, false, "", false, "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Sản phẩm Áo sơ mi trắng nam", "Sản phẩm Áo sơ mi trắng nam", "vi-VN", "Áo sơ mi trắng nam AAA", 1, "ao-so-mi-trang-nam", "Sản phẩm Áo sơ mi trắng nam", "Sản phẩm Áo sơ mi trắng nam" },
                    { 2, "The aaa t-shirt products for men", "The aaa t-shirt products for men", "en-US", "AAA Men T-Shirt", 1, "aaa-men-tshirt", "The aaa t-shirt products for men", "The aaa t-shirt products for men" }
                });
